      ...
      <section className="content">
        ...
        <div className="content__text">
          ...
          <p>
            ...
            technical standpoint, I spend most of my time working with
          ...
          <br />
          <p>
            I’ve worked for myself my entire life. I’ve graduated of Universty
            of Tehran’s Electrical and Computer Enginering (ECE) school where I
            obtained my Bachelor of software engineering.
          </p>
          <br />
          <p>
            When not creating websites, I love to spend my time with my family
            and friends. In my free time I play flamenco ,aka spanish, guitar.
            I'm also a bookworm and obsessed with movies.
          </p>
          <br />
          <p>
